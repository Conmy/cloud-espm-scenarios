...
import com.sap.espm.model.extension.web.util.HttpResponse;
import com.sap.espm.model.extension.web.util.RequestExecutionHelper;
import com.sap.espm.model.extension.web.util.StreamHelper;
import com.sap.espm.model.extension.web.util.XMLParser;
...
public class CustomerReviewOdataIT {
	...
	private static final String FILENAME = "com/sap/espm/model/extension/web/customerReview.xml";
	...
	public void testReadPreloadedCustomerReviewExists() throws IOException {
		checkExistenceOfCustomerReviewViaREST("1");
	}
